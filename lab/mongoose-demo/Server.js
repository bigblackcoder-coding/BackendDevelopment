...
// Set MONGODB_URI in the terminal before starting the server.
const DB_URL = 'mongodb+srv://maheshwarigarvit339_db_user:<123456>@cluster0.hg22ijf.mongodb.net/?appName=Cluster0';

if (!DB_URL) {
  console.error('MongoDB connection error: set the MONGODB_URI environment variable');
} else {
